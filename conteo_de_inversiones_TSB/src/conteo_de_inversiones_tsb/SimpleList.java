...
public class SimpleList<E extends Comparable> implements Iterable<E> {
    ...
    /**
     * Agrega el objeto x en la posicion index de la lista. Los objetos que se
     * encontraban en la lista a partir de esa posicion, se desplazan hacia la
     * derecha. Se toma como convencion que el primer nodo esta en la posicion
     * cero. Note que el metodo puede agregar un elemento en una lista vacia, o
    ...
    /**
     * Inserta un objeto en forma ordenada en la lista. La insercion se hara
     * solo si el parametro recibido no es null y si el objeto representado es
    ...
    /**
     * Retorna (removiendo de la lista) el objeto menor de toda la lista.
     *
     * @return el indice del objeto menor.
     * @throws IndexOutOfBoundsException si index esta fuera de rango.
     */
    public int getIndiceMenor()
    {
        int indiceP = 1,indiceMenor = 0;
        Node<E> p = frente.getNext(), q = frente, antP = frente, antQ = frente;//p se encarga de el numero siguiente, q almacena el menor, antP siempre tiene el anterior de p, que me sirve para cuando p encuentre un menor nuevo, hago que antQ apunte a antP.
        while (p != null) {
        ...
        {
            antQ.setNext(q.getNext());//Elimino el nodo q, que es el numero menor encontrado.
        }
        return indiceMenor;
    }
